        ...
        if (pivotBy.length) {
          var groupRecursively = function groupRecursively(rows, keys) {
            ...
            var groupedRows = Object.entries(_.groupBy(rows, keys[i])).map(function (_ref2) {
              ...
              return _ref4 = {}, defineProperty(_ref4, pivotIDKey, keys[i]), defineProperty(_ref4, pivotValKey, key), defineProperty(_ref4, keys[i], key), defineProperty(_ref4, subRowsKey, value), defineProperty(_ref4, nestingLevelKey, i), defineProperty(_ref4, groupedByPivotKey, true), _ref4;
            });
